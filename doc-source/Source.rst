...
The ``gunshotmatch-reports`` source code is available on GitHub,
...
The recommended way to build ``gunshotmatch-reports`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
